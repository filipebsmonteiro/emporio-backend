 ...
 *    MS ExcelPHP 2007 workbooks reader
 *
 ...
 * $xlsx = SimpleXLSX::parse('book.xlsx');
 * print_r( $xlsx->sheetNames() ); // [ 1 => 'Sheet 1', 3 => 'Catalog' ];
 *
 ...
 * + sheetNames() - returns [ sheet_id => sheet_name, sheet_id2 => sheet_name2 ...]
